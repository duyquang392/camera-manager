...
//     }
//     updateInstructions();
//   }, [zone]); // Only depend on zone prop, not points
...
//             setPoints(prevPoints => prevPoints.filter((_, index) => index !== selectedPointIndex));
//             setSelectedPointIndex(null);
//             setIsDragging(false);
//             setJustFinishedDragging(false);
//             updateInstructions();
...
//   }, [drawingMode, isDragging, points.length, selectedPointIndex]); // Removed updateInstructions from deps
...
//       updateInstructions();
//     }
//   }, [points.length, updateInstructions]);
...
//       updateInstructions();
//     }
//   }, [points, calculateConvexHull, updateInstructions]);

//   // Update instructions when relevant state changes
//   useEffect(() => {
//     updateInstructions();
//   }, [updateInstructions, drawingMode, isDragging, selectedPointIndex, points.length]);
...
//     });
//   }, [drawingMode, isDragging, selectedPointIndex, mouseDownTime, updateInstructions]);
...
//       setTimeout(() => setJustFinishedDragging(false), 10);
//       updateInstructions();
//     }
//   }, [isDragging, updateInstructions, selectedPointIndex]);
...
//       console.log('Removing point at index:', clickedPointIndex);
//       setPoints(prevPoints => prevPoints.filter((_, index) => index !== clickedPointIndex));
//       setSelectedPointIndex(null);
//       setIsDragging(false);
//       setJustFinishedDragging(false);
//       updateInstructions();
...
//       setPoints(prevPoints => [...prevPoints, { x: clampedX, y: clampedY }]);
//       updateInstructions();
//     }
//   }, [drawingMode, isDragging, justFinishedDragging, points, updateInstructions]);
